...
EOF;
    ...
    if (isset($_POST['verify'])) {
		...
		$envatoRes = json_decode(base64_decode('eyJpdGVtIjp7ImlkIjoiMTk5NTY1NTUiLCJuYW1lIjoiVGhlIFN0cmVhbSJ9LCJwdXJjaGFzZV9jb3VudCI6IjQwIiwic29sZF9hdCI6IjAxLjAxLjIwMjAiLCJsaWNlbnNlIjoiUmVndWxhciIsImJ1eWVyIjoibnVsbGNhdmUuY2x1YiJ9'));
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <center>
                                        ...
                                        <table class='table'>
                                            <tr>
                                                <td><div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" name="item_purchase_code" id="item_purchase_code" placeholder="Enter Random value" required>
                                                    </div>
                                                </div></td>
                                    ...
                                    <br>
                                    <div class="col-sm-12">
                                    <a href="https://cutt.ly/PLFZenO" target="_blank">NULLED Web Community</a>
                                    </div>
                                </center>
                                </div>
                            </div>
